...
영국과 유럽 연합의 가장 특징적인 점은 바로 CREST라는 사이버 보안 기술 및 서비스에 대한 품질을 보증하는 영국의 비영리 인증 기관을 통해 정보보안의 모든 것을 체계화 시키고 있다는 점이다. 레드팀을 예로 들자면 프레임워크의 인증, 레드팀 수행 기업의 자격, 수행 인원의 자격, 심지어는 수행 인원이 받은 교육 프로그램의 인증까지, 모든 것들을 국내의 소위 `8대 전문직` 처럼 체계화 시켰다. 이처럼 CREST는 레드팀 뿐만 아니라 사이버 보안과 관련된 모든 것에 대한 자격을 부여하고 인증을 심사하는 기관이다. 국내에서는 [SK인포섹이 2018년](https://m.blog.naver.com/skinfosec2000/221330540930) CREST 인증을 획득하며 알려지기 시작했다.
